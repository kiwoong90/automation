...
WebUI.click(findTestObject('Object Repository/Page_/span_create'))

WebUI.click(findTestObject('Object Repository/Page_/label_add'))

WebUI.setText(findTestObject('Object Repository/Page_/textarea_1'), '1')

WebUI.setText(findTestObject('Object Repository/Page_/textarea_12'), '12')

WebUI.setText(findTestObject('Object Repository/Page_/textarea_123'), '123')
